...
class BotContent:
    welcome_text: str = (
        ...
        "Проектируем и производим мебель под пространство клиента: кухни, шкафы, "
        "гардеробные, гостиные, спальни, детские, офисы и прихожие.\n\n"
        "Здесь можно посмотреть направления, узнать о бюро, найти контакты или "
    ...
    catalog_text: str = (
        ...
        "Если нужной категории нет, оставьте заявку: изготовим мебель под ваши "
    ...
    contacts_text: str = (
        ...
        "Email: hello@furniture-bureau.ru\n"
    ...
    order_phone_prompt: str = (
        "Шаг 2 из 3. Укажите ваш номер телефона.\n"
        "Например: +7 900 123-45-67"
    )
    order_details_prompt: str = (
        "Шаг 3 из 3. Расскажите, что вас интересует.\n\n"
    ...
    order_edit_text: str = "Начнем заново.\n\nШаг 1 из 3. Как вас зовут?"
    ...
    unknown_command_text: str = (
        "Выберите действие в меню или начните оформление заявки."
    )
    invalid_contact_text: str = "Не распознал контакт."
    crm_success_text: str = (
        "Спасибо! Заявка принята и передана менеджеру. Мы свяжемся с вами в "
